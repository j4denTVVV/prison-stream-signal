...
function RosterPage() {
  ...
  const revealedCount = roster.filter((r) => r.revealed).length;

  return (
    <PageShell
      kicker={terms.group}
      title="Who's inside?"
      subtitle="The names are coming. Some identities will be revealed. Others remain behind closed doors. File numbers below are placeholders — they do not indicate how many people are inside."
    >
